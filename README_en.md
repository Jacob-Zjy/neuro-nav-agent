...
[中文首页](README.md) · [Live project guide](https://jacob-zjy.github.io/neuro-nav-agent/) · [Offline HTML](docs/index.html) · [Data provenance](data/README.md)
...
The committed snapshot contains **1,968 unique public study registrations**
...
The snapshot includes `ACTIVE_NOT_RECRUITING` records (ongoing studies that are
not recruiting). It must not be interpreted as a list of currently available
